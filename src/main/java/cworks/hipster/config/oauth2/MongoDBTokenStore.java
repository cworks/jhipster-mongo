package cworks.hipster.config.oauth2;

import cworks.hipster.domain.OAuth2AuthenticationAccessToken;
import cworks.hipster.domain.OAuth2AuthenticationRefreshToken;
